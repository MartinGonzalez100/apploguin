...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-09-2023 a las 17:31:13
...
INSERT INTO `gasto_gral` (`id`, `id_providers`, `n_factura`, `f_factura`, `importe_f`, `desc_tem`, `desc_iibb`, `desc_iva`, `desc_gan`, `desc_suss`, `importe_pagar`, `a_fondo`, `type`, `saldo_fondo`) VALUES
(2, 7, '0001-00000111', '2023-08-08', 251144.64, 3139.31, 12557.23, 21799.35, 3679.49, 2075.58, 207893.68, '202307', 'FF', 2222224.50),
(4, 7, '0001-00000111', '2023-08-08', 722040.84, 9025.51, 36102.04, 62673.14, 13097.42, 5967.28, 595175.45, '202307', 'FF', 555555.00),
(5, 8, '0001-00000111', '2023-08-08', 120000.00, 1560.00, 1440.00, 12000.00, 10566.00, 29752.07, 64681.93, '202308', 'FF', 35000.00),
(6, 9, '0001-00000222', '2023-08-08', 130000.00, 3250.00, 6500.00, 0.00, 0.00, 0.00, 120250.00, '202308', 'FF', 333333.00);
...
--
-- Estructura Stand-in para la vista `viewgralnamevieja`
-- (Véase abajo para la vista actual)
--
CREATE TABLE `viewgralnamevieja` (
`id` int(11)
,`id_providers` int(4)
,`n_factura` varchar(20)
,`f_factura` date
